...
```json
{
  ...
  "bsGitRepository" : "github.com?owner=0x2615&repo=tanzu-java-restful-web-app"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=0x2615&repo=tanzu-java-restful-web-app'
